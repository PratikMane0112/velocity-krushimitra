...
const ChatBot = () => {
    ...
    const [messages, setMessages] = useState([
        {
            message: "Hello, This is KrushiBot!!! Ask me anything!",
            sentTime: "just now",
            sender: "gemini-pro",
        },
    ]);
    ...
    const handleSend = async (msg) => {
        ...
        if (INTRO_WORDS.includes(sanitizedMessage.toLowerCase())) {
            setMessages((prevMessages) => [
                ...
                newMessage,
                {
                    message: "Hello!! Welcome to कृषिMitra !!!",
                    sender: "gemini-pro",
                },
            ]);
            return;
    ...
    return (
        <>
            ...
            >
                <div className="w-full h-full bg-white overflow-auto rounded-[15px] p-3">
                    <MainContainer style={{ border: 0, borderRadius: 15 }}>
                        <ChatContainer>
                            <MessageList
                                scrollBehavior="smooth"
                                typingIndicator={
                                    isTyping ? <TypingIndicator content="KrushiBot is typing..." /> : null
                                }
                            >
                            ...
                            <MessageInput
                                ...
                                className="bg-[#E8F5E9] border border-[#8BC34A] text-[#2E7D32] rounded-md p-2"
                                onSend={handleSend}
                            />
                        </ChatContainer>
                    </MainContainer>
